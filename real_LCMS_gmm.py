...
class LCMS_GMMDeconvolver:
    ...
    """
    def __init__(self, min_intensity=5e3, max_components=3, saturation=20.0):
        """
...
# DATA PREPARATION
    ...
    def _apply_anisotropy_scaling(self):
        ...
        self.mz_shrink = (mz_step / rt_step) * 0.7
...
# POST FIT VALIDATION
    ...
    def _align_means_to_local_maxima(self, gmm):
        ...
        for i, mean in enumerate(gmm.means_):
            ...
            if best_dist < 1.0:  # Only snap if Mahalanobis distance is close
